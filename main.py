...
app = FastAPI(title='Mayson Generated APIs - boring-stallman-a853a87033', debug=False,
              docs_url='/docs',
              openapi_url='/openapi.json',
              root_path='/us-east-2-backstractelb-621aff-coll-c766e74b4a974272b188e43d174331e7')
