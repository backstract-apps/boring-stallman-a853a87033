...
async def auth_package_middleware(request: Request) -> Dict[str, Any]:
    ...
    Generated from middleware ID: mid_cf8059f3dac240cfaea6fbbf5d466802
    """
    try:
...
async def cors_middleware(request: Request) -> Dict[str, Any]:
    """
    CORS Middleware
    Generated from middleware ID: mid_4b18f6f0da134e26bf1ed36a6dc8f006
    """
    try:
